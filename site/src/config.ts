...
// live URL for local builds. See `url` below + astro.config.mjs.
...
//     at the real public v0.4.1 installers (soryq-releases), so nothing else needs
...
const RELEASE_BASE = 'https://github.com/Samuel00098/soryq-releases/releases/download/v0.4.1';
...
export const downloads = [
  {
    ...
    href: `${RELEASE_BASE}/Soryq_0.4.1_x64-setup.exe`,
  ...
  },
  {
    ...
    file: 'Disk image (.dmg)',
    href: `${RELEASE_BASE}/Soryq_0.4.1_aarch64.dmg`,
  ...
  },
  {
    ...
    href: `${RELEASE_BASE}/Soryq_0.4.1_amd64.AppImage`,
...
// (same philosophy as the hero mockup + "demo coming soon" poster).
