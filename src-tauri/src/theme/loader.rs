...
pub fn load_bundled_themes() -> Vec<Theme> {
    ...
    let dark_theme = Theme {
        ...
        colors: [
            ...
            ("selection-bg", "rgba(174, 182, 194, 0.2)"),
            ("titlebar-bg", "#121216"),
            ...
            ("input-focus-border", "#aeb6c2"),
            ("button-bg", "#3f4650"),
            ("button-hover-bg", "#4b525d"),
            ("button-text", "#ffffff"),
        ]
        .iter()
    ...
    let light_theme = Theme {
        ...
        colors: [
            ...
            ("scrollbar-track", "transparent"),
            ("selection-bg", "rgba(91, 100, 112, 0.22)"),
            ("titlebar-bg", "#fafafa"),
            ...
            ("input-focus-border", "#5b6470"),
            ("button-bg", "#3f4650"),
            ("button-hover-bg", "#2f343b"),
            ("button-text", "#ffffff"),
        ]
        .iter()
        .map(|(k, v)| (k.to_string(), v.to_string()))
